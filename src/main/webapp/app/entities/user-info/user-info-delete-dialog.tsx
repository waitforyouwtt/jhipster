...
export class UserInfoDeleteDialog extends React.Component<IUserInfoDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.userInfoEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="putongApp.userInfo.delete.question">Are you sure you want to delete this UserInfo?</ModalBody>
        <ModalFooter>
          <Button color="secondary" onClick={this.handleClose}>
            <FontAwesomeIcon icon="ban" />&nbsp; Cancel
          </Button>
          <Button id="jhi-confirm-delete-userInfo" color="danger" onClick={this.confirmDelete}>
